...
export default class unlockKey extends Component {
    render() {
      return (
        <View style={{ flex: 1 }}>
        ...
        <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
          <TouchableOpacity style={{ alignItems: 'center',justifyContent: 'center',backgroundColor: '#066DB3', width: 280,height: 50,borderRadius: 12,borderRadius: 25}}>
            <Text style={{color: '#ffff', fontSize: 20, fontFamily: 'Quicksand', fontWeight: 'bold', letterSpacing: 0.5 }}>Return Key and Unlock</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
